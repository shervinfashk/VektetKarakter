function oppdaterPoeng() {
    ...
    siste.innerHTML =
      slider.value +
      " Dette tilsvarer bokstavverdi: " +
      regnUtKarakterVerdi(slider.value);
    output.innerHTML =
      regnUtHøyestePoengMulig(slider.value) +
      " " +
      "Dette tilsvarer bokstavverdi: " +
      regnUtKarakterVerdi(regnUtHøyestePoengMulig(slider.value));
  }
  ...
  function fjernKarakter() {
    ...
    let poengSum = document.getElementById("poeng");
    poengSum.value = "";
  ...
  function skrivUtVektet() {
    ...
    li.innerText =
      "Oppnådde poeng på midtveiseksamen: " +
      karakter.hentPoeng() +
      " " +
      "Dette tilsvarer bokstavverdi: " +
      regnUtKarakterVerdi(karakter.hentPoeng());
    list.appendChild(li);
